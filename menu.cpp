...
void switch_menu(int cmd) {
    // استفاده از Singleton برای دسترسی به شی واحد game_manager
    ...
    switch (cmd) {
        ...
        case 3: { // تاریخچه بازی
            ...
            cout << "Enter the history file name: ";
            cin >> filename;
            cout << "Enter your user ID: ";
            cin >> userid;
            int result = gam->display_history(filename, userid);
            if (result != -1) {
